...
// CRITICAL: No Portal wrapper - this makes dropdown render inline
const SelectContent = React.forwardRef(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Content
    ref={ref}
    className={cn(
      "relative z-50 max-h-96 min-w-(--radix-select-trigger-width) overflow-hidden rounded-md border border-gray-200 bg-white text-gray-900 shadow-lg",
      position === "popper" &&
